...
public final class PACEye {
    ...
    public static String encrypt(String privateKey, String plainText) {
        try {
            ...
            return PACBase64.encode(write.toByteArray());
     ...
     * @return
     */
    public static String decrypt(String publicKey, String enStr) {
        try {
            Cipher cipher = Cipher.getInstance(RSA);
            cipher.init(Cipher.DECRYPT_MODE, getPublicKey(publicKey));

            byte[] bytes = PACBase64.decode(enStr);
            ByteArrayInputStream read = new ByteArrayInputStream(bytes);
            ByteArrayOutputStream write = new ByteArrayOutputStream();
    ...
    public static PublicKey loadPublicKey(String publicKeyStr) throws Exception {
        try {
            byte[] buffer = PACBase64Utils.decode(publicKeyStr);
            KeyFactory keyFactory = KeyFactory.getInstance(RSA);
    ...
    public static PrivateKey loadPrivateKey(String privateKeyStr) throws Exception {
        try {
            byte[] buffer = PACBase64Utils.decode(privateKeyStr);
            // X509EncodedKeySpec keySpec = new X509EncodedKeySpec(buffer);
